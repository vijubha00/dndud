    ...
    try:
       ...
       #     elif "https://cpvod.testbook.com/" in url or "classplusapp.com/drm/" in url:
             #   url = url.replace("https://cpvod.testbook.com/","https://media-cdn.classplusapp.com/drm/")
              #  url = f"https://covercel.vercel.app/extract_keys?url={url}@bots_updatee&user_id={8226659957}"
           ...
           # elif "classplusapp" in url:
              #  signed_api = f"https://covercel.vercel.app/extract_keys?url={url}@bots_updatee&user_id={8226659957}"
             #   response = requests.get(signed_api, timeout=60)
             #   url = response.text.strip()
              #  url = response.json()['url']  
                
         #   e#lif "tencdn.classplusapp" in url:
